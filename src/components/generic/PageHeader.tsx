...
export function PageHeader({ title, description, badgeText, badgeIcon: BadgeIcon, action }: PageHeaderProps) {
  return (
    <section className="mb-8 overflow-hidden rounded-3xl sm:rounded-[2rem] border border-border/60 bg-background/80 shadow-[0_18px_60px_-35px_rgba(0,0,0,0.35)] backdrop-blur-sm">
