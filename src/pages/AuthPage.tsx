...
export default function AuthPage() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-4/12 h-full flex flex-col px-6 sm:px-12 md:px-16 lg:px-24 pt-16 pb-24 relative z-10 bg-background overflow-y-auto">
        <div className="w-full max-w-sm mx-auto mt-0 md:mt-12 space-y-6 text-card-foreground">
          <div className="text-center space-y-4">
            <img src={logoSrc} alt="Bora-Estudar Logo" className="w-40 md:w-48 mx-auto" />
            <div>
              <h1 className="text-3xl md:text-4xl font-display font-bold tracking-tight">
                {mode === 'login' ? 'Comece seus estudos' : mode === 'signup' ? 'Crie seu perfil' : 'Recuperar Senha'}
              </h1>
              <p className="text-emerald-300 font-semibold text-lg md:text-xl">
                {mode === 'login' ? 'e conquiste seus objetivos' : mode === 'forgot_password' ? 'Enviaremos um link de acesso' : ''}
              </p>
            </div>
          </div>
          ...
          {mode !== 'forgot_password' && (
            <>
              ...
              <div className="text-center text-sm uppercase text-muted-foreground mt-6">ou</div>
            </>
          )}
            ...
            {mode === 'signup' && (
              <div className="flex items-start gap-3 pt-2">
                ...
                <label htmlFor="terms" className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  <Link to="/termos" className="text-emerald-400 hover:underline font-medium">
                    Termos de Uso
                  </Link>{' '}
                  e{' '}
                  <Link to="/privacidade" className="text-emerald-400 hover:underline font-medium">
